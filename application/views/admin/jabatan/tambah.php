            ...
            <div class="col-xl-12 col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Pilih List</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control default-select" name="benefit1" id="benefit1">
                                    <option value="" hidden>-- Tidak ada yang dipilih --</option>
                        ...
                        <br>
                        <hr>
                        <a href="<?= site_url('admin/jabatan') ?>" class="btn btn-danger">Kembali</a>&nbsp;&nbsp;
